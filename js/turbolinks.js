(function() {
  ...
  changePage = function(doc, options) {
    var changedNodes, csrfToken, currentBody, extractedTitle, nodesToChange, nodesToKeep, ref, ref1, scriptsToRun, targetBody, title;
    ref = extractTitleAndBody(doc), extractedTitle = ref[0], targetBody = ref[1], csrfToken = ref[2];
    title = (ref1 = options.title) != null ? ref1 : extractedTitle;
